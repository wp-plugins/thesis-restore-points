...
abstract class ThesisRestorePoints {
			...
			$(document).ready(function() {
				...
				var create_backup = function() {
					...
					$.get(ajaxurl, {
						...
						$(data).insertAfter('#current-backups tr:first');
					});
				...
				$('#name').keypress(function(e) {
					if (e.which == 13 || e.which == 10) return create_backup();
				});
			});
		})(jQuery);
	</script>
	<div class="wrap">
		...
		<label for="name">Backup Name</label> <input type="text" id="name" name="name" value="first backup"/>
	...
	private static function render_row($post) {
